      ...
      >
        ...
        <div className="max-w-3xl mx-auto px-4 pt-10">
          ...
          <section id="consent" className="scroll-mt-20 mb-16">
            ...
            >
              <h3
                className="font-heading font-bold text-base mb-4 text-center"
                style={{ color: 'var(--text-brand)' }}
              >
                Parent or Guardian Declaration
              </h3>
              <P>
                I, the undersigned, confirm that I have read all three parts of this Registration Agreement – the
                Terms and Conditions, the Privacy Policy, and this Parental Consent Form – in their entirety. I
                confirm that I give my free, specific, informed, and unambiguous consent to all of the above, and
                agree to be bound by these terms on behalf of my child.
              </P>

              <div
                className="mt-6 rounded-lg border p-5 space-y-3"
              ...
              <div
                ...
                style={{ background: 'var(--brand-subtle)', borderColor: 'var(--border-brand)' }}
              >
                <div
                  className="size-4 shrink-0 mt-0.5 rounded border flex items-center justify-center"
                  style={{ borderColor: 'var(--border-brand-strong)', background: 'var(--bg-card)' }}
                  aria-hidden="true"
                >
                  <div className="size-2 rounded-sm" style={{ background: 'var(--brand)' }} />
                </div>
                <p className="font-body text-sm font-semibold" style={{ color: 'var(--text-1)' }}>
                  I have read, understood, and agree to the Terms and Conditions, Privacy Policy, and Parental
                  Consent Form in full.
                </p>
              </div>
            </div>
          </section>
