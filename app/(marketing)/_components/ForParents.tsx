    ...
    >
      ...
      <div className="relative max-w-5xl mx-auto px-4 sm:px-6">
        ...
        >
          ...
          <a
            href="#"
            className="inline-flex items-center gap-2.5 h-[48px] px-6 rounded-[4px] border font-heading font-semibold text-[13px] tracking-[0.08em] uppercase transition-all duration-150 flex-shrink-0"
            style={{
          ...
          {/* WhatsApp pill */}
          <span
            className="inline-flex items-center gap-2 px-4 h-[40px] rounded-full border font-body text-[12px] leading-snug"
            style={{
          ...
          >
            <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4 flex-shrink-0" style={{ color: '#22C55E' }} aria-hidden="true">
